		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd none">
					<?php if(is_array($cateA)): $i = 0; $__LIST__ = $cateA;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="cat item1">
						
							<h3><a href=""><?php echo ($vol["cate_name"]); ?></a> <b></b></h3>
						
								<div class="cat_detail ">
									<?php if(is_array($cateB)): $i = 0; $__LIST__ = $cateB;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($vol["id"]) == $v["pid"]): ?><dl class="dl_1st">
											<dt><a href=""><?php echo ($v["cate_name"]); ?></a></dt>
											<?php if(is_array($cateC)): $i = 0; $__LIST__ = $cateC;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i; if(($v["id"]) == $vv["pid"]): ?><dd>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goodsData)): $i = 0; $__LIST__ = $goodsData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
							<dl>
								<dt><a href="<?php echo U('Goods/detail',array('goods_id' => $vol['id']));?>"><img src="<?php echo C('SITE_URL'); echo (substr($vol["goods_small_logo"],2)); ?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('Goods/detail',array('goods_id' => $vol['id']));?>"><?php echo ($vol["goods_name"]); ?></a></dd>
								<dd><strong><?php echo ($vol["goods_price"]); ?></strong></dd>
							</dl>
