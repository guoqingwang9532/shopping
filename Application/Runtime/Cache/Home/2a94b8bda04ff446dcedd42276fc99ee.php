	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到京西！
					<?php if( $_SESSION['adminName']== "" ): ?>[<a href="<?php echo U('user/login');?>">登录</a>] [<a href="<?php echo U('user/register');?>">免费注册</a>]
					<?php else: ?>
					<?php echo session('adminName');?> <a href="<?php echo U('User/login');?>">退出</a><?php endif; ?>
					 </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					<?php if(is_array($cateA)): $i = 0; $__LIST__ = $cateA;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="cat item1">
							<h3><a href="<?php echo U('goods/showlist',array('cat_id'=> $vol['id']));?>"><?php echo ($vol["cate_name"]); ?></a> <b></b></h3>
							<div class="cat_detail">
								<?php if(is_array($cateB)): $i = 0; $__LIST__ = $cateB;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(($vol["id"]) == $v["pid"]): ?><dl class="dl_1st">
											<dt><a href="<?php echo U('goods/showlist',array('cat_id'=> $v['id']));?>"><?php echo ($v["cate_name"]); ?></a></dt>
											<?php if(is_array($cateC)): $i = 0; $__LIST__ = $cateC;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i; if(($v["id"]) == $vv["pid"]): ?><dd>
														<a href="<?php echo U('goods/showlist',array('cat_id'=> $vv['id']));?>"><?php echo ($vv["cate_name"]); ?></a>						
