        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
              <a href="tianjia.html"><img src="images/add.gif" width="10" height="10" /> 添加</a>   &nbsp; 
              </span>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
        ...
        <img src="images/del.gif" width="10" height="10" /> 删除 | 查看 | <a href='/index.php/Admin/Role/edit/id/<?php echo ($vol["id"]); ?>'><img src="images/edit.gif" width="10" height="10" /> 编辑</a></div></td>
