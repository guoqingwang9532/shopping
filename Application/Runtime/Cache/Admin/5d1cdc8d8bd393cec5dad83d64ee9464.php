...
<form id="login" name="login" action="/index.php/Admin/Maneger/login.html" method="post">
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="chknumber">
        <label>验证码：
        <input name="capache" type="text" id="chknumber" maxlength="4" class="chknumber_input" />
        
        <img src="<?php echo U('Maneger/capache');?>" id="safecode" onclick="this.src='/index.php/Admin/Maneger/capache/_/'+Math.random()" />
        </label>
      </div>
    </div>
